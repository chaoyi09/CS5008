...
//
// Compile this assignment with: gcc -g -Wall my_stack_test.c -o my_stack_test
//
// Run with: ./my_stack_test
//
...
int unitTest1(int status){
    ...
    my_stack_t* test_s = create_stack(32);
...
int unitTest2(int status){
    ...
    my_stack_t* test_s = create_stack(MAX_DEPTH);
...
int unitTest5(int status){
    ...
    my_stack_t* test_s = create_stack(1);
    stack_enqueue(test_s,1);
